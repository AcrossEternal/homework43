...
function displayOrderList(cartData) {
    ...
    for (const i in orderList) {
        ...
        // 为缩短引用当前订单，设置一个变量order替代当前订单的数组描述
        ...
        //方法2：设置节点属性
        // 获取标题节点并设置标题
        // let titleNode = orderNode.querySelector('[data-name="title"]');
        // titleNode.textContent = orderList[i].title;
        // // 获取图像节点并设置图像地址
        // let imgNode = orderNode.querySelector('[data-name="img"]');
        // imgNode.src = orderList[i].imgSrc;
        // //获取价格节点并设置价格
        // let priceNode = orderNode.querySelector('[data-name="price"]');
        // priceNode.textContent = orderList[i].price;
        // //获取数量节点并设置数量
        // let qtyNode = orderNode.querySelector('[dataname="qty"]');
